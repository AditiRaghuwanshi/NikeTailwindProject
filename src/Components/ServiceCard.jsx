...
const ServiceCard = ({ imgURL, label,subtext}) => {
  return (
   ...
   rounded-[20px] shadow-3xl px-10 py-16">
    ...
    <h3 className="mt-5 font-palanquin font-bold
    leading-normal text-3xl">{label}</h3>
    <p className="mt-3 break-words text-slate-gray font-montserrat text-lg leading-normal">{subtext}</p>
   </div>
  )
}
