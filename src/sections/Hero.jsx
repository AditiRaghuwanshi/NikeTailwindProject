  ...
  return (
    ...
    w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin 
            ...
            mt-3">Nike</span>Items
           
        </h1>
        <p className="mt-6 mb-14 font-montserrat text-slate-gray
        text-lg leading-8 sm:max-w-sm">
         New Collection keeping your comfort, quality a basic need and a need of survival.</p>
